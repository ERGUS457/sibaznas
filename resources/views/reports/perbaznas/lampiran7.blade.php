...
<div class="max-w-6xl mx-auto space-y-6 print:max-w-none print:space-y-0 print:m-0 print:p-0">
    ...
    <div class="no-print print:hidden flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
        ...
        <div class="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-2 w-full lg:w-auto">
            <form method="GET" class="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-2 text-xs w-full sm:w-auto">
                ...
                <select id="month" name="month" class="border border-slate-300 rounded px-2 py-1.5 sm:py-1 focus:ring-1 focus:ring-black w-full sm:w-auto text-sm sm:text-xs">
                ...
                <input type="number" id="year" name="year" value="{{ $year }}" min="2020" max="2035" class="w-full sm:w-20 border border-slate-300 rounded px-2 py-1.5 sm:py-1 focus:ring-1 focus:ring-black text-sm sm:text-xs">
    ...
    <div class="report-sheet-wrapper overflow-x-auto -mx-4 sm:mx-0 px-4 sm:px-0"><div class="report-sheet bg-white p-4 sm:p-8 lg:p-12 border border-slate-300 shadow-sm text-black font-serif text-[12px] leading-relaxed print:p-0 print:border-none print:shadow-none">
